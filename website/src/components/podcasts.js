...
export const podcasts = {
  ...
  arpit: {
    ...
    type: "spotify",
    description:
      "Ahmedabad is the largest city in the state of Gujarat (goo jer raht) in western India. It has a population of over eight million people. This is where Arpit Joshipura, GM of LFNetworking at the Linux Foundation, was born and raised.",
    podcast: "The Untold Stories of Open Source",
    podcastUrl: "https://untold-stories-of-open-source.captivate.fm/spotify",
    featured: true,
  },
  ...
  ashley: {
    title: "Managing an Open Source Program Office, with Ashley Wolf",
    src: "https://open.spotify.com/embed/episode/12rMujLaSN70blkoZOpy2J?utm_source=generator",
    type: "spotify",
    description: `It’s a consistent pattern at most companies: High-value data and corporate memory are stored in isolated channels on disparate systems. Old processes are protected by those who have been there the longest. The problem is, the DNA of the company becomes lost as long-time employees depart, making it difficult for new hires to find what is available, why decisions were made, and who they can look to for answers.`,
    podcast: "The Untold Stories of Open Source",
    podcastUrl: "https://untold-stories-of-open-source.captivate.fm/spotify",
    featured: true,
  },
